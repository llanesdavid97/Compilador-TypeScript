...
namespace Compilador_JavaScript
{
    public partial class Form1 : Form
    {
        ...
        private void btn_Run_Click(object sender, EventArgs e)
        {
            ...
            //var lexico = new Lexico(rt_Path.Text);
            //lexico.EjecutarLexico();

            //dataGridTokens.DataSource = lexico.listaTokens;
            //dataGridErroresLexico.DataSource = lexico.listaError;

            //dataGridTokens.DataSource = null;
            //dataGridTokens.AutoGenerateColumns = true;
            //dataGridTokens.Rows.Add(lexico.listaTokens);
            //List<Token> tokens = lexico.listaTokens;
            ...
            {
                dataGridErroresLexico.Rows.Add(error.mensajeError, error.codigo, error.tipo, error.Linea);

            }
        }

        private void dataGridErroresLexico_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
